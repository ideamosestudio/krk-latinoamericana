...
const items: ProductItem[] = [
  {
    title: { es: "Sistema de manipuleo de carbón", en: "Coal Handling Systems" },
    images: [
  ...
  {
    title: { es: "Sistemas de manejo de granos", en: "Grain Handling Systems" },
    images: [
  ...
  {
    title: { es: "Sistemas de recepción y transferencia", en: "Material Receiving and Transfer Facilities" },
    images: [
  ...
  {
    title: { es: "Sistemas de apilación", en: "Stockpile Systems" },
    images: [
