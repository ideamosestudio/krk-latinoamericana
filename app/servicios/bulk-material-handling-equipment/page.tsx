...
const items: ProductItem[] = [
  ...
  {
    title: { es: "Cintas Tubo", en: "Pipe Conveyors" },
    images: [
    ...
    es: "Diseñadas para recorridos complejos, las cintas tubo permiten el transporte continuo de materiales a través de terrenos desafiantes, reduciendo estaciones de transferencia, optimizando la eficiencia energética y minimizando las emisiones de polvo, los derrames de material y el impacto ambiental.",
  },
  {
  ...
  },
  {
    ...
    en: "Innovative conveying systems combining low maintenance requirements, quiet operation and high reliability through air-supported technology, reducing mechanical wear while providing clean and efficient bulk material transportation.",
    es: "Sistemas innovadores de transporte que combinan bajos requerimientos de mantenimiento, operación silenciosa y alta confiabilidad mediante tecnología de banda soportada por aire, reduciendo el desgaste mecánico y proporcionando un transporte limpio y eficiente de materiales a granel.",
  },
  {
  ...
  {
    title: { es: "Grasshoppers", en: "Grasshoppers" },
    images: [
